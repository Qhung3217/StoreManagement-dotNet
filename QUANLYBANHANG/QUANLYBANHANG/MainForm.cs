...
namespace QUANLYBANHANG
{
    public partial class MainForm : Form
    {
        ...
        {
            Form frm = new DanhMucDonThanhPhoForm();
        ...
        {
            Form frm = new DanhMucDonKhachHangForm();
        ...
        {
            Form frm = new DanhMucDonNhanVienForm();
        ...
        {
            Form frm = new DanhMucDonSanPhamForm();
        ...
        {
            Form frm = new DanhMucDonHoaDonForm();
        ...
        {
            Form frm = new DanhMucDonChiTietHoaDonForm();
        ...
        {
            Form frm = new DanhMucNhomKhachHangTheoThanhPhoForm();
            frm.Text = "Quản lý Danh mục nhóm Khách Hàng theo Thành Phố";
            frm.ShowDialog();
        }

        private void hóaĐơnTheoKháchHàngToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form frm = new DanhMucNhomHoaDonTheoKhachHang();
            frm.Text = "Quản lý Danh mục nhóm Hóa Đơn theo Thành Phố";
            frm.ShowDialog();
        }

        private void hóaĐơnTheoNhânViênToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form frm = new DanhMucNhomHoaDonTheoNhanVien();
            frm.Text = "Quản lý Danh mục nhóm Hóa Đơn theo Nhân Viên";
            frm.ShowDialog();
        }

        private void chiTiếtHóaĐơnTheoHóaĐơnToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form frm = new DanhMucNhomChiTietHoaDonTheoHoaDon();
            frm.Text = "Quản lý Danh mục nhóm Chi Tiết Hóa Đơn theo Hóa Đơn";
            frm.ShowDialog();
        }
    }
}
